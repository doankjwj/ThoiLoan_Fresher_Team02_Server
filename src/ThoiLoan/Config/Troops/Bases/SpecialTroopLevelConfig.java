...
public class SpecialTroopLevelConfig extends BaseTroopConfig
{
    public SpecialTroopLevelConfig(int Type)
    {
        JsonObject TroopType;
        try
        {
            TroopType =
                RawJsonConfig.TroopBase.getAsJsonObject(RawJsonConfig.Barrack.getAsJsonObject("BAR_2").getAsJsonObject(String.valueOf(Type))
        ...
        {
            Levels =
                new ResearchTroopLevelConfig[RawJsonConfig.Troop.getAsJsonObject(RawJsonConfig.Barrack.getAsJsonObject("BAR_2")
        ...
        {
            TroopType =
                RawJsonConfig.Troop.getAsJsonObject(RawJsonConfig.Barrack.getAsJsonObject("BAR_2").getAsJsonObject(String.valueOf(Type))
                                          .getAsJsonPrimitive("unlockedUnit").getAsString());
        }
        catch (Exception e)
        {
